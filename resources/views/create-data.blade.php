            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        <h1 class="mt-3">Tambah Stok Barang Baru</h1>
                        <br>
                        ...
                        <form id="form-login" action="{{ route('toko.buat-data') }}" method="post">
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg @error('JumlahStock') is-invalid @enderror" name="JumlahStock" type="text"
                                       placeholder="Jumlah Stock" value="{{ old('JumlahStock') }}" >
                            </div>
